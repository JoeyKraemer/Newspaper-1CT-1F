...
<html>
    ...
    <body>
                ...
                case 'addEvent':
                    ...
                    if($deleteFlag == 8 && isset($event_id)){
                        if($user_type == 1 || $user_type == 2){
                            ...
                            echo "your account does not have the required permission to delete entries";
                        }
                    }
                    ...
                    if(isset($event_id)){
                        if($user_type == 1 || $user_type == 2){
                            ...
                            echo "your account does not have the required permission to modify entries";
                        }
                    } else {
        ...
        echo "
        <h2>add event</h2>
        <form id='addEventForm' action='eventsTool.php' method='post'>
